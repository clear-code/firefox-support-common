...
VERIFY_MANUAL_OPT= -c assets/esr153.conf -a assets/esr153.var
...
configurations-sheet: verify-targets-to-chapters.csv
	./build-xlsx -o config-$(DATE).xlsx -d ESR140:assets/esr140.conf -d ESR153:assets/esr153.conf -d "ESR153 派生:assets/esr153-variation.conf" verify-targets-to-chapters.csv
